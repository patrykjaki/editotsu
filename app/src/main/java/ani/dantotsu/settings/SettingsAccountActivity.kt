        ...
        binding.apply {
            ...
            fun reload() {
                if (Anilist.token != null) {
                    ...
                    } else if (!MAL.isLoginAvailable()) {
                        // No-credential build: truthful unavailable state,
                        // never a login action that can only fail.
                        settingsMALAvatar.setImageResource(R.drawable.ic_round_person_24)
                        settingsMALAvatar.setOnClickListener(null)
                        settingsMALUsername.visibility = View.GONE
                        settingsMALLogin.setText(R.string.mal_login_unavailable)
                        settingsMALLogin.isEnabled = false
                        settingsMALLogin.setOnClickListener(null)
                    } else {
                        settingsMALAvatar.setImageResource(R.drawable.ic_round_person_24)
                        settingsMALAvatar.setOnClickListener {
