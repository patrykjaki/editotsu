    ...
    fun buildPerFilePerformanceOptions(
        ...
        when (sourceClass) {
            ...
            PlaybackSourceClass.TORRENT_LOCALHOST -> {
                ...
                optionsList.add("demuxer-lavf-probesize=262144")
                optionsList.add("demuxer-lavf-analyzeduration=0.1")
                optionsList.add("demuxer-mkv-probe-video-duration=no")
                optionsList.add("demuxer-mkv-subtitle-preroll=no")
                optionsList.add("demuxer-lavf-buffersize=65536")
                optionsList.add("network-timeout=30")
                optionsList.add("cache=yes")
                optionsList.add("cache-pause-initial=no")
